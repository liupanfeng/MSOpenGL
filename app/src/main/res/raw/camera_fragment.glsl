...
/*float 数据的精度 （precision lowp = 低精度）
...
// uniform sampler2D vTexture;  由于我们用的是 安卓的相机，就不能用他  sampler2D == GL_TEXTURE_2D
uniform samplerExternalOES vTexture; // samplerExternalOES才能采样相机的数据 == GLES11Ext.GL_TEXTURE_EXTERNAL_OES
